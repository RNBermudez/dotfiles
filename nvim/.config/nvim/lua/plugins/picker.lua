...
vim.api.nvim_create_autocmd("LspAttach", {
	...
	callback = function(args)
		...
		Keys.map_leader({ "n", "v" }, "ra", bind(picker.lsp_code_actions), "Code actions", buf)
		Keys.map_leader({ "n", "v" }, "ri", bind(picker.lsp_implementations), "Find implementations", buf)
		Keys.map_leader({ "n", "v" }, "rn", vim.lsp.buf.rename, "Rename symbol", buf)
		Keys.map_leader({ "n", "v" }, "rr", bind(picker.lsp_references), "Find references", buf)
